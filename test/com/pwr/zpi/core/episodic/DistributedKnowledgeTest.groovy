...
class DistributedKnowledgeTest extends GroovyTestCase {
    ...
    void buildTestObject() {
        ...
        testDk1 = new DistributedKnowledge(agent, sformula1, false) //with simple formula - at least one matching base profile
        testDk2 = new DistributedKnowledge(agent, cformula1,  false) //with complex formula - at least one matching base profile
        testDk3 = new DistributedKnowledge(agent, sformula2,  false) //with other simple formula - at least one matching base profile
        testDk4 = new DistributedKnowledge(agent, sformula1, t3, false) // till given timestamp
        testDk5 = new DistributedKnowledge(agent, sformula3,  false) //only one matching base profile
        testDk6 = new DistributedKnowledge(agent, cformula2,  false) // empty results
    ...
    void testConstructor() {
        build()
        testDk1 = new DistributedKnowledge(agent, sformula1, false)
